 ...
 *
 * Index 0 is always a white-background pack shot for catalogue cards.
 * Lifestyle / banner frames follow.
...
export const PRODUCT_PHOTOS: Record<string, string[]> = {
  ...
  "dr-frei-multivitamins-biotin-20": ["/products/dr-frei-multivitamins-biotin-20-4.webp", "/products/dr-frei-multivitamins-biotin-20-2.webp", "/products/dr-frei-multivitamins-biotin-20-3.webp", "/products/dr-frei-multivitamins-biotin-20-1.webp"],
