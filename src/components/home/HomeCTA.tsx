...
export function HomeCTA() {
  ...
  return (
    <section className="border-t border-line py-24 sm:py-32">
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border border-line bg-surface px-8 py-20 text-center sm:px-16 sm:py-28">
            <Aurora className="opacity-70" variant="spectrum" />
